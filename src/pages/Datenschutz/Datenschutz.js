    ...
    <div className='cd_datenschutz'>
     <h2>Datenschutzerklärung:</h2>
      ...
      <p>
        ...
        personenbezogenen Daten im Sinne des Bundesdatenschutzgesetzes (BDSG)
        ist
        <br />
        <br />
        Carpe Diem, Pater-Otto-Hopfenmüller Str. 1, 96260 Weismain
        <br />
        <br />
        Sofern Sie der Erhebung, Verarbeitung oder Nutzung Ihrer Daten durch
        Carpe Diem gemäß den datenschutzrechtlichen Bestimmungen insgesamt oder
        für einzelne Maßnahmen widersprechen möchten, richten Sie Ihren
        Widerspruch per Brief an folgende Kontaktdaten:
        <br />
        <br />
        Fitnessstudio Carpe Diem Sport und Wellness GmbH
      ...
      <p>
        Bei dem Besuch unserer Website erheben, verwenden und speichern wir Ihre
        personenbezogenen Daten. Personenbezogene Daten sind nach § 3 Abs. 1
      ...
      <br />
      <p>
        <strong>Datenerhebung unter strenger Beachtung der Gesetze</strong>
      </p>
      <p>
        Bei der Erhebung, dem Verwenden und Speichern von personenbezogenen
        Daten beachten wir die Vorschriften des Bundesdatenschutzgesetzes, des
        Telemediengesetzes und ggf. weiterer anwendbarer
        Datenschutzbestimmungen. Alle Kundendaten werden unter Beachtung der
        einschlägigen Vorschriften des Bundesdatenschutzgesetzes (BDSG) und des
      ...
      <p>
        ...
        Daten. Sie haben die Möglichkeit, das Abspeichern von Cookies auf Ihrem
        Rechner durch entsprechende Einstellungen in Ihrem Browser zu
        verhindern. Hierdurch könnte allerdings der Funktionsumfang unseres
      ...
      <p>
        ...
        Sperrung. Wenden Sie sich hierzu bitte an die im Impressum angegebene
        Kontaktadresse. Wir stehen Ihnen jederzeit gern für weitergehende Fragen
        zu unseren Hinweisen zum Datenschutz und zur Verarbeitung Ihrer
